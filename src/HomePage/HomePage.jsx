        ...
        <div className="flex md:hidden">
          <div className="relative flex items-center justify-between w-full px-4 py-4 bg-white shadow-2xl md:px-8">
            ...
            <button
              ...
              className="absolute flex items-center justify-center p-2 overflow-hidden rounded-full left-2"
            >
              {open ? (
                <svg
                  stroke="currentColor"
        ...
        <main className="w-full px-4 py-6 md:px-8 md:ml-72 bg-imbg">
          {!open ? (
            ...
            <div>
              ...
              <nav class="flex-grow px-5 pb-4 md:block md:pb-0">
                <div class="pt-4 pb-4 border-gray-100 ">
                  <a
                    target="_self"
                    class="group menu-section flex items-center px-5 py-3"
                    href="#/token-management"
                  >
                    <img
                      class="mr-3"
                      ...
                      alt="icon"
                    />
                    <span class="text-sm">Token management</span>
                  </a>
                  <a
                    target="_self"
                    class="group menu-section flex items-center px-5 py-3"
                  ...
                  >
                    <img
                      ...
                      alt="icon"
                    />
                    <span class="text-sm">Apply for IDO</span>
                  </a>
                  <a
                    target="_self"
                    class="group menu-section flex items-center px-5 py-3"
